...
from _eval_visa import evaluate
...
def train(args, category, rotate_90=False, random_rotate=0):
    ...
    dataset = VisADataset(
        is_train=True,
        visa_dir=args.visa_path + category + "/train/good/",
    ...
    ####
    torch.save(seg_optimizer.state_dict(), os.path.join(args.checkpoint_path, run_name +"_seg_optim.pckl"))
    torch.save(de_st_optimizer.state_dict(), os.path.join(args.checkpoint_path, run_name +"_st_optim.pckl"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--visa_path", type=str, default="../datasets/visa/")
    parser.add_argument("--dtd_path", type=str, default="../datasets/dtd/images/")
    parser.add_argument("--checkpoint_path", type=str, default="./visa_saved_model/")
    parser.add_argument("--run_name_head", type=str, default="DeSTSeg_VisA")
    ...
    parser.add_argument("--eval_per_steps", type=int, default=9999)
    parser.add_argument("--log_per_steps", type=int, default=1000)
    ...
    if args.custom_training_category:
        ...
        no_rotation_category = ['candle','capsules','cashew','chewinggum','fryum','macaroni1','macaroni2','pcb1','pcb2','pcb3','pcb4','pipe_fryum']
