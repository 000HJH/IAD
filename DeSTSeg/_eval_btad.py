...
def evaluate(args, category, model, visualizer, global_step=0):
    ...
    with torch.no_grad():
        dataset = BTadDataset(
            is_train=False,
            btad_dir=args.btad_path + category + "/test/",
...
def test(args, category):    
    ...
    run_name = f"DeSTSeg_BTad_test_{category}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model_name", type=str, default="DeSTSeg_BTad_5000_")
    parser.add_argument("--log_path", type=str, default="./logs/")

    parser.add_argument("--bs", type=int, default=32)
    parser.add_argument("--T", type=int, default=100)  # for image-level inference

    parser.add_argument("--category", nargs="*", type=str, default=['01','02','03'])
