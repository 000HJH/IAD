...
def evaluate(args, category, model, visualizer, global_step=0):
    ...
    with torch.no_grad():
        dataset = VisADataset(
            is_train=False,
            visa_dir=args.visa_path + category + "/test/",
...
def test(args, category):    
    ...
    run_name = f"DeSTSeg_VisA_test_{category}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model_name", type=str, default="DeSTSeg_VisA_5000_")
    parser.add_argument("--log_path", type=str, default="./logs/")

    parser.add_argument("--bs", type=int, default=32)
    parser.add_argument("--T", type=int, default=100)  # for image-level inference

    parser.add_argument("--category", nargs="*", type=str, default=['candle','capsules','cashew','chewinggum','fryum','macaroni1','macaroni2','pcb1','pcb2','pcb3','pcb4','pipe_fryum'])
