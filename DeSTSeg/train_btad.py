...
from _eval_btad import evaluate
...
def train(args, category, rotate_90=False, random_rotate=0):
    ...
    dataset = BTadDataset(
        is_train=True,
        btad_dir=args.btad_path + category + "/train/ok/",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--btad_path", type=str, default="../datasets/btad/")
    parser.add_argument("--dtd_path", type=str, default="../datasets/dtd/images/")
    parser.add_argument("--checkpoint_path", type=str, default="./btad_saved_model/")
    parser.add_argument("--run_name_head", type=str, default="DeSTSeg_BTAD")
