...
@click.option("--results_path", type=str, default="results") #ft_results/glass_mvtec_lr000001_occlr0001_occrat10_warmup01_400s_optim_optional
# @click.option("--results_path", type=str, default="results_optim")
...
def dataset(
    ...
    _DATASETS = {"mvtec": ["datasets.mvtec", "MVTecDataset"], "visa": ["datasets.visa", "VisADataset"],
                 ...
                 "btad": ["datasets.btad", "BTadDataset"], "mvtecloco": ["datasets.mvtecloco", "LOCODataset"]}
